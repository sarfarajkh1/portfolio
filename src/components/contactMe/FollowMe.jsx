...
const FollowMe = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: contact.socialMedia.github,
      ...
      <div className="flex flex-wrap gap-4">
        {socialLinks.map((social, index) => (
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className={`size-12 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-white transition-all duration-300 ${social.color}`}
            title={social.name}
          >
            {social.icon}
          </motion.a>
